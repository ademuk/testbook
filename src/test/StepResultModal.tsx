...
const StepResultModal = ({stepAndResult: [step, {result, error}], onClose}: StepResultModalProps) => (
  <Modal onClose={onClose}>
    ...
    <ModalFooter>
      <button className="bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-full my-2 mr-2"
              onClick={onClose}
      >
        Close
      </button>
