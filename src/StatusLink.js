...
export const Link = ({link, children, className = null}) =>
  <RouterLink to={link}
              className={`flex font-medium text-gray-700 hover:text-gray-600 hover:bg-gray-100 rounded-lg p-2 my-2 ${className}`}>
...
const StatusLink = ({link, children, subTitle = null, status = null, className = null}) =>
  <RouterLink to={link}
              className={`flex text-gray-700 hover:text-gray-600 hover:bg-gray-100 rounded-lg p-2 px my-2 ${className}`}>
